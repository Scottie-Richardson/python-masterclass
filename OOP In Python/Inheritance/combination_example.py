...
"""
    ...
    There is one important fact to keep in mind when choosing between using composition and aggregation. With compostion the
instances of the objects created within that class and will be destroyed once that particular instance of the class is destroyed.
While aggregation allows for objects to be created outside the scope of a single class, and will remain after the class that is
currently using them is destroyed. The code below uses aggregation, while the code above uses composition.
