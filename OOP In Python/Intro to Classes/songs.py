...
def load_data():
    ...
    ###################################################################################################################
    #     The code below was refactored to the the code above by adding the 'add_song' method to the Artist class     #
    ###################################################################################################################
    #                                                                                                                 #
    # new_artist = None                                                                                               #
    # new_album = None                                                                                                #
    ...
    #             new_album = None                                                                                    #
    #                                                                                                                 #
    #         """ Read a new album for the current artist """                                                         #
